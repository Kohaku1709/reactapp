...
function CalendarPicker({ label, icon, value, onChange }) {
  ...
  const selectDate = (day) => {
    ...
    const str = d.toLocaleDateString("vi-VN", { day: "2-digit", month: "2-digit", year: "numeric" });
    onChange(str);
    setOpen(false);
  };
  ...
  const isSelected = (day) => {
    ...
    const d = new Date(viewYear, viewMonth, day);
    return d.toLocaleDateString("vi-VN", { day: "2-digit", month: "2-digit", year: "numeric" }) === value;
  };
            ...
            <div className="cal-grid">
              ...
              {Array.from({ length: daysInMonth }).map((_, i) => {
                ...
                return (
                  <button
                    key={day}
                    className={`cal-day ${isSelected(day) ? "selected" : ""} ${isPast(day) ? "past" : ""}`}
                    onClick={() => !isPast(day) && selectDate(day)}
                    disabled={isPast(day)}
                  >
                    {day}
                  </button>
    ...
    <div className="app">
      ...
      <header className="header">
        <div className="header-inner">
          ...
          <nav className="nav">
            <a href="#" className="nav-link active">Khách sạn</a>
            <a href="#" className="nav-link">Chuyến bay</a>
            <a href="#" className="nav-link">Resort</a>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="search-box">
            ...
            <button className="search-btn" onClick={() => setSearchDone(true)}>
              🔍 Tìm kiếm
            </button>
          </div>
        </div>
        ...
        <div className="section-inner">
          <div className="section-header">
            <h2 className="section-title">
              {searchDone ? `Kết quả tại "${destination}"` : "Khách sạn nổi bật"}
            </h2>
          ...
          <div className="load-more-wrap">
            <button className="load-more-btn">Xem thêm khách sạn</button>
          </div>
        </div>
      </section>
